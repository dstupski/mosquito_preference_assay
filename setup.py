...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "triangulator = mosquito_preference_assay.triangulator_node:main",
            "pipeline_monitor = mosquito_preference_assay.pipeline_monitor_node:main",
            "benchmark = mosquito_preference_assay.benchmark_node:main",
